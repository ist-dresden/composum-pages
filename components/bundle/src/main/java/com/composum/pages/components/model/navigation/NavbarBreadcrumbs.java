...
public class NavbarBreadcrumbs extends NavbarItem {

    private static final Logger LOG = LoggerFactory.getLogger(NavbarBreadcrumbs.class);
    ...
    public class BreadcrumbsMenu extends NavbarMenu {
        ...
        public BreadcrumbsMenu() {
            super(NavbarBreadcrumbs.this.context, NavbarBreadcrumbs.this.resource);
        }
        ...
        public Menuitem getCurrent() {
            if (current == null) {
                ...
                if (current == null) {
                    current = NavbarBreadcrumbs.this;
                }
            }
            return current;
        }
    ...
    public NavbarBreadcrumbs() {
    }

    public NavbarBreadcrumbs(BeanContext context, Resource resource) {
