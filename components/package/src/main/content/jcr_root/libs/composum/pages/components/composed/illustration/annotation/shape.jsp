...
<cpp:element var="annotation" type="com.composum.pages.components.model.composed.illustration.Annotation"
             cssSet="@{annotationCSS}_shape type-@{annotation.shapeType} icon-@{annotation.iconType} btn btn-@{annotation.shapeLevel}"
             style="@{annotation.shapeStyle}" data-id="@{annotationId}">
    <a class="${annotation.iconClasses} ${annotationCSS}_link" role="button" tabindex="0" data-toggle="popover"
