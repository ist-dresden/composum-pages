...
<%@taglib prefix="cpp" uri="http://sling.composum.com/cppl/1.0" %><cpp:defineFrameObjects/>
<cpp:editDialog title="@{dialog.selector=='create'?'Create a Carousel':'Edit Carousel'}">
    <div class="row">
    ...
    <div class="row">
        <div class="col col-xs-4">
            <cpp:widget label="Interval" property="interval" type="textfield" hint="(milliseconds)"/>
        </div>
