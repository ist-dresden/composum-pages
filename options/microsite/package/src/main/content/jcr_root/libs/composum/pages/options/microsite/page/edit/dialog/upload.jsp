...
<%--
  - the dialog is using a MicrositePage model instance to access the page properties
  ...
  - after a successful upload the result messages are displayed in a simple dialog and a page
    refresh in the Pages edit frame is triggered by a 'page:reload' DOM event
--%>
<cpp:editDialog var="microsite" type="com.composum.pages.options.microsite.model.MicrositePage"
                ...
                successEvent="messages;page:reload">
