...
<div class="composum-pages-edit-multiwidget multiwidget-simple widget multi-form-widget form-group"
    ...
    <label class="control-label composum-pages-edit-multiwidget_label"><span class="label-text">${cpn:text(widget.label)}</span><sling:call script="labelextension.jsp"/><sling:call script="hint.jsp"/></label>
