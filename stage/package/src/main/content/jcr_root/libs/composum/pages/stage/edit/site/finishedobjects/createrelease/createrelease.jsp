...
<cpp:editDialog tagId="createrelease-dialog" var="site" type="com.composum.pages.commons.model.Site"
    ...
    <cpp:widget label="Release Key" name="releaseName" placeholder="enter release key" type="text"/>
    <cpp:widget label="Release Title" name="title" placeholder="enter release title" type="text"/>
    <cpp:widget label="Description" name="description" placeholder="enter a description" type="text"/>
</cpp:editDialog>
