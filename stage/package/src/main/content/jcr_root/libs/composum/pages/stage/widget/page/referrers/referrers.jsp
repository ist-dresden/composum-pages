...
<div class="${widgetCssBase}_${widget.widgetType} ${widgetCssBase}_${widget.cssName} form-group">
    ...
    <div class="${widgetCssBase}_wrapper widget page-referrers-widget widget-name_${widget.cssName}${empty widget.model.references?' empty':''}"
        ...
        <c:choose>
            <c:when test="${empty widget.model.references}">
                <div class="${widgetCssBase}_empty">
                    <cpn:text tagClass="${widgetCssBase}_paragraph alert alert-info"
                              value="no referrers" i18n="true"/>
                </div>
            </c:when>
            <c:otherwise>
